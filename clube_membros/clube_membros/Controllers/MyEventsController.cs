...
namespace clube_membros.Controllers
{
    public class MyEventsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,City,EventDate")] Events events)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,City,EventDate")] Events events)
        {
            if (ModelState.IsValid)
            {
